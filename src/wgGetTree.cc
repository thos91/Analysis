...
bool wgGetTree::SetTreeFile(Raw_t& rdin){
  ...
  tree->SetBranchAddress("bcid",rdin.bcid.data());
  tree->SetBranchAddress("charge",rdin.charge.data());
  tree->SetBranchAddress("time",rdin.time.data());
  tree->SetBranchAddress("gs",rdin.gs.data());
  tree->SetBranchAddress("hit",rdin.hit.data());
  tree->SetBranchAddress("chipid",rdin.chipid.data());
  tree->SetBranchAddress("col",rdin.col.data());
  tree->SetBranchAddress("chipch",rdin.chipch.data());
  tree->SetBranchAddress("chip",rdin.chip.data());
  tree->SetBranchAddress("debug",rdin.debug.data());
  tree->SetBranchAddress("view",&rdin.view);
  tree->SetBranchAddress("pln",rdin.pln.data());
  tree->SetBranchAddress("ch",rdin.ch.data());
  tree->SetBranchAddress("grid",rdin.grid.data());
  tree->SetBranchAddress("x", rdin.x.data());
  tree->SetBranchAddress("y", rdin.y.data());
  tree->SetBranchAddress("z", rdin.z.data());
  tree->SetBranchAddress("time_ns",rdin.time_ns.data());
  tree->SetBranchAddress("pe",rdin.pe.data());
  tree->SetBranchAddress("gain",rdin.gain.data());
  tree->SetBranchAddress("pedestal",rdin.pedestal.data());
  tree->SetBranchAddress("ped_nohit",rdin.ped_nohit.data());
  return true;
}
